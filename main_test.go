...
func TestEntrypoint(t *testing.T) {
	...
	t.Run("200 - integration for correct routing", func(t *testing.T) {
		testCorrectRouting("./mocks/pathsWithWildCardCollision.json", t)
		testCorrectRouting("./mocks/pathsWithWildCardCollision2.json", t)
	})
}
